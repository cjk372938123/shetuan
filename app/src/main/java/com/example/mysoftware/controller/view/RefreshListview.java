package com.example.mysoftware.controller.view;
...
public class RefreshListview extends ListView {
    ...
    private void initFooterView(Context context) {
        footerView = View.inflate(context, com.atguigu.refreshlistview.R.layout.refresh_footer, null);
    ...
    private void initHeaderView(Context context) {
        headerView = (LinearLayout) View.inflate(context, com.atguigu.refreshlistview.R.layout.refresh_header, null);
        //下拉刷新控件
        ll_pull_down_refresh = headerView.findViewById(com.atguigu.refreshlistview.R.id.ll_pull_down_refresh);
        iv_arrow = (ImageView) headerView.findViewById(com.atguigu.refreshlistview.R.id.iv_arrow);
        pb_status = (ProgressBar) headerView.findViewById(com.atguigu.refreshlistview.R.id.pb_status);
        tv_status = (TextView) headerView.findViewById(com.atguigu.refreshlistview.R.id.tv_status);
        tv_time = (TextView) headerView.findViewById(com.atguigu.refreshlistview.R.id.tv_time);
