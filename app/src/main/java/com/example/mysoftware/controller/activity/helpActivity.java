...
public class helpActivity extends Activity implements View.OnClickListener{
    ...
    private void findViews() {
        tvTitle = (TextView) findViewById(R.id.mtv_title);
    ...
    public void onClick(View v) {
        if (v == ibBack) {
            ...
            Toast.makeText(helpActivity.this, "设置文字大小", Toast.LENGTH_SHORT).show();
            showChangeTextSizeDialog();
        } else if (v == ibShare) {
            // Handle clicks for ibShare
            Toast.makeText(helpActivity.this, "分享", Toast.LENGTH_SHORT).show();
            showShare();
        }
    }
...
// title标题，微信、QQ和QQ空间等平台使用
        oks.setTitle("这是我从福大社团软件分享的活动新闻");
...
//        webview.loadUrl(url);
        ...
        可以加载网页
         */
        webview.loadUrl("http://8.129.90.225:8080/hello/hello.html");
    }
}