package com.example.mysoftware.utils;
...
public class CacheUtils {
    ...
    public static boolean getBoolean(Context context, String key) {
        SharedPreferences sp = context.getSharedPreferences("mySoftWare", Context.MODE_PRIVATE);
    ...
    public static void putString(Context context, String key, String value) {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            ...
            try {
                ...
                ///mnt/sdcard/beijingnews/files/llkskljskljklsjklsllsl
                File file = new File("/data/data", fileName);
